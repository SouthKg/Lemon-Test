<template>
  <h2>Actualités du groupe Veolia</h2>
  <div class="card-loop">
    <CardActu v-for="(card, index) in cards" :key="index" :image-src="card.imageSrc" :title="card.title" :description="card.description" :date="card.date" />
  </div>
</template>

<script>
import CardActu from './CardActu.vue';
